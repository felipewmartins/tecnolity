...
public class Pedido
{
    ...
    public Pedido(long codigo) throws Exception
    {
        definirCodigo(codigo);
    }
    
    public Pedido(String status, long codigo) throws Exception
    {
        definirCodigo(codigo);
        definirStatus(status);
    }
    
    public Pedido(long codigo, String ordemCompra) throws Exception
    {
        definirCodigo(codigo);
        definirOrdemCompra(ordemCompra);
    }
    
    public Pedido(long codigo, Cliente cliente, String ordemCompra, String dataEmissao, String dataEntrega, String status, float valorTotal) throws Exception
    {
        definirCodigo(codigo);
    ...
    public void definirValorTotal(float valorTotal)
    {
        this.valorTotal = valorTotal;
    }
    
    public int obterNumeroRegistros()
    {
    ...
    public Vector obterNumeracaoProdutos(String referencia)
    {
    ...
    public LocalEntrega obterLocalEntrega()
    {
     ...
     */
    public String importarArquivoEDI(File arquivo) throws Exception
    {
     ...
     */
    public void associarProdutos(Vector produtosPedido) throws Exception
    {
        Conexao conexao = new Conexao('T');
    ...
    public void carregarPedido(Conexao conexao)
    {
	 ...
	 * @throws Exception 
	 */
    public static Vector carregarPedidosClientes(Conexao conexao) throws Exception
    {
    ...
    public static Vector carregarPedidosPendentes(Conexao conexao) throws Exception
    {
        ResultSet dadosPedido;
        Vector pedidos = new Vector();
    ...
    public static Vector carregarPedidosProduzindo(Conexao conexao) throws Exception
    {
        ResultSet dadosPedido;
        Vector pedidos = new Vector();
	 ...
	 * @throws Exception
	 */
    public static String[][] carregarRecursosPedido(Conexao conexao, Pedido pedido) throws Exception
    {
    ...
    public Vector carregarHistoricoPedido(Conexao conexao) throws Exception
    {
