...
* Nome do Arquivo: DlgDadosRequisicaoInterna.java
* Linguagem: Java
* 
* Requerimentos: Requer máquina virtual java versão 1.3 ou superior.
* 
* Objetivo: Diálogo para cadastramento e cancelamento de dados de uma requisição interna.
* 
* Objetivo definido por: Kenia Soares
* Início da Programação: 27/02/2002
* Fim da Programação:
* Última Versão: 1.0
*/
...
import br.com.tecnolity.administracao.ui.DlgDadosDepartamento;
