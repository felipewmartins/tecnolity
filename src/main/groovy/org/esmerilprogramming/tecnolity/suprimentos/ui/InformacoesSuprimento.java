...
/**
   ...
   * Nome do Arquivo: InformacoesSuprimento.java <br>
   * Linguagem: Java <br>
   *  <br>
   * Requerimentos: Requer máquina virtual java versão 1.3 ou superior. <br>
   *  <br>
   * Objetivo: Área onde os dados de suprimento são apresentados. <br>
   *  <br>
   * Objetivo definido por: Hildeberto Mendonça <br>
   * Início da Programação: 22/12/2001 <br>
   * Fim da Programação: <br>
   * Última Versão: 1.0 <br>
*/

public class InformacoesSuprimento extends JTabbedPane implements ActionListener
{
    ...
    public InformacoesSuprimento(Aplicacao aplicacao) 
    {
        ...
        String[] titulos = {"Item","Necessário","Requisitado","%","Disponível","%"};
        ...
        int numeroItens = 100;
        String[] titulosTabelaInventario = {"Código","Descrição","Quantidade","Valor Unitário","Total"};
        try
        {
