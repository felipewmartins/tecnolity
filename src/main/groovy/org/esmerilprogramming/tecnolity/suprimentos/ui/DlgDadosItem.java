...
* Nome do Arquivo: DlgDadosItem.java
* Linguagem: Java
* 
* Requerimentos: Requer máquina virtual java versão 1.3 ou superior.
* 
* Objetivo: Diálogo para cadastramento,alteração e visualização de dados de um item.
* 
* Objetivo definido por: Hildeberto Mendonça
* Início da Programação: 23/12/2001
* Fim da Programação:
* Última Versão: 1.0
*/

public class DlgDadosItem extends JDialog implements ActionListener, FocusListener
{
