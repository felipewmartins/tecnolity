...
* Nome do Arquivo: DlgDadosLote.java
* Linguagem: Java
* 
* Requerimentos: Requer máquina virtual java versão 1.3 ou superior.
* 
* Objetivo: Diálogo para cadastramento,alteração e visualização de dados de um lote.
* 
* Objetivo definido por: Kenia Soares
* Início da Programação: 09/03/2002
* Fim da Programação:
* Última Versão: 1.0
*/
...
{ 
    ...
    private void carregarLocalizacoes()
    {
        ...
        Categoria categoria
        for(int i = 1i < localizacoes.size()i++)
        {
