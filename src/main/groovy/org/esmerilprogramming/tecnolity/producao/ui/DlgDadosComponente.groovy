...
/**
   ...
   * Nome do Arquivo: DlgDadosComponente.java <br>
   * Linguagem: Java <br>
   *  <br>
   * Requerimentos: Requer máquina virtual java versão 1.3 ou superior. <br>
   *  <br>
   * Objetivo: Diálogo para cadastramento,alteração e visualização de dados de um componente. <br>
   *  <br>
...
public class DlgDadosComponente extends JDialog implements ActionListener, FocusListener
{
    public final int IDENTIFICADOR = 11
    ...
    public DlgDadosComponente(Aplicacao aplicacao, char modo)
    {
