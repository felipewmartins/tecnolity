...
* Nome do Arquivo: DlgDadosVeiculo.java
* Linguagem: Java
* 
* Requerimentos: Requer máquina virtual java versão 1.3 ou superior.
* 
* Objetivo: Diálogo para cadastramento,alteração e visualização de dados de um veículo.
* 
* Objetivo definido por: Kenia Soares
* Início da Programação: 14/02/2002
* Fim da Programação:
* Última Versão: 1.0
*/
