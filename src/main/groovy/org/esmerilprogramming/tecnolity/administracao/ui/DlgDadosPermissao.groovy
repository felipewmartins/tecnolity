...
* Nome do Arquivo: DlgDadosPermissao.java <br>
* Linguagem: Java <br>
*  <br>
* Requerimentos: Requer máquina virtual java versão 1.3 ou superior. <br>
*  <br>
* Objetivo: Diálogo para definição das permissões dos usuários. <br>
*  <br>
 ...
 class DlgDadosPermissao extends JDialog implements ActionListener
{
    ...
    private void carregarInterfaces()
    {
        ...
        for(int i = 0i < interfaces.size()i++)
        {
    ...
    private void carregarPermissoesLeitura()
    {
        ...
        for(int i = 0i < acessosLeitura.size()i++)
        {
    ...
    private void carregarPermissoesEscrita()
    {
        ...
        for(int i = 0i < acessosEscrita.size()i++)
        {
        ...
        if(colaborador != null)
        {
            try
            {
                ...
                for(int i = 0i < permissoes.size()i++)
                {
                    ...
                    for(int j = 0j < interfaces.size()j++)
                    {
