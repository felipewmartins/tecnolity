...
/**
   ...
   * Nome do Arquivo: InformacoesAdministracao.java <br>
   * Linguagem: Java <br>
   *  <br>
   * Requerimentos: Requer máquina virtual java versão 1.3 ou superior. <br>
   *  <br>
   * Objetivo: Área onde os dados da administracao são apresentados. <br>
   *  <br>
...
public class InformacoesAdministracao extends JTabbedPane implements ActionListener, KeyListener
{
