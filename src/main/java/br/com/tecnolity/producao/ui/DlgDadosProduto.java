...
import br.com.tecnolity.pedidos.ui.DlgDadosCliente;
import br.com.tecnolity.producao.*;
import br.com.tecnolity.suprimentos.*;
import br.com.tecnolity.suprimentos.ui.DlgDadosItem;
...
/**
   ...
   * Nome do Arquivo: DlgDadosProduto.java <br>
   * Linguagem: Java <br>
   *  <br>
   * Requerimentos: Requer máquina virtual java versão 1.3 ou superior. <br>
   *  <br>
   * Objetivo: Diálogo para cadastramento,alteração e visualização de dados de um produto. <br>
   *  <br>
...
public class DlgDadosProduto extends JDialog implements ActionListener
{
