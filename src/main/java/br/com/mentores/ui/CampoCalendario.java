...
public class CampoCalendario extends JPanel implements ActionListener, KeyListener, FocusListener
{
    ...
    public CampoCalendario(final JFrame aplicacao, final String formato, final int tamanho) {
    ...
    public CampoCalendario(final JFrame aplicacao, final Calendario calendario, final String formato, final int tamanho) {
        this.tamanhoMaximo = 10;
        this.aplicacao = aplicacao;
        this.formato = formato;
        this.tamanho = tamanho;
    ...
    public void setData(final Calendario calendario) {
        this.calendario = calendario;
        if (calendario != null) {
    ...
    public void keyReleased(final KeyEvent evento) {
        this.digitado = true;
        if (evento.getKeyCode() == 8) {
            return;
        }
    ...
    public void keyTyped(final KeyEvent evento) {
    }
