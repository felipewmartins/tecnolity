...
public class Numero extends DecimalFormat
{
    ...
    public Numero(final BigDecimal dec) {
    ...
    public Numero(final double dec) {
        this.nro = new ArrayList();
        this.qualificadores = new String[][] { { "centavo", "centavos" }, { "", "" }, { "mil", "mil" }, { "milh\u00e3o", "milh\u00f5es" }, { "bilh\u00e3o", "bilh\u00f5es" }, { "trilh\u00e3o", "trilh\u00f5es" }, { "quatrilh\u00e3o", "quatrilh\u00f5es" }, { "quintilh\u00e3o", "quintilh\u00f5es" }, { "sextilh\u00e3o", "sextilh\u00f5es" }, { "septilh\u00e3o", "septilh\u00f5es" } };
        this.numeros = new String[][] { { "zero", "um", "dois", "tr\u00eas", "quatro", "cinco", "seis", "sete", "oito", "nove", "dez", "onze", "doze", "treze", "quatorze", "quinze", "desesseis", "desessete", "dezoito", "desenove" }, { "vinte", "trinta", "quarenta", "cinquenta", "sessenta", "setenta", "oitenta", "noventa" }, { "cem", "cento", "duzentos", "trezentos", "quatrocentos", "quinhentos", "seiscentos", "setecentos", "oitocentos", "novecentos" } };
        this.setNumber(dec);
    ...
    public void setNumber(final BigDecimal dec) {
    ...
    public void setNumber(final double dec) {
    ...
    public static String formatarNumero(final double numero, final String padrao, final int casasDecimais) {
    ...
    public static String formatarNumero(final double numero, final String padrao, final int casasDecimais, final char separadorDecimal, final char separadorMilhar) {
        final DecimalFormatSymbols dfs = new DecimalFormatSymbols();
    ...
    public static boolean isNumeroValido(final String numero) {
        boolean valido = true;
        try {
    ...
    public static int hexadecimalParaDecimal(final String hexadecimal) {
