...
public class Texto
{
    public static String formatarTextoHTML(final String texto) {
        return texto.replaceAll("\n", "<br>");
    }
    
    public static String getStringTamanhoFixo(final String texto, final int tamanho) {
    ...
    public static String getNumeroTamanhoFixo(final String numero, final int tamanho, final String preenchimento) {
    ...
    public static String ajustarTexto(final String texto) {
        return texto.replaceAll("'", "''");
    }
    
    public static String[] getTextoAlinhado(final String texto, final int largura) {
        String[] linhas;
        if (texto == null) {
            linhas = new String[] { "" };
        }
